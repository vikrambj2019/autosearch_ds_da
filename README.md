...
For model building, Dexter runs multiple rounds of improvement automatically — each round it tries one change, keeps it if the model gets better, discards it if not. It stops when the model is good enough or stops improving.
